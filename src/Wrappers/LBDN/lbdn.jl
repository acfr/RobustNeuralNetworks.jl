...
This constructor takes a direct parameterisation of LBDN
(eg: a [`DenseLBDNParams`](@ref) instance) and converts it to a
**callable** explicit parameterisation of the LBDN.
